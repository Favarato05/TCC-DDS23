...
module.exports = {
    ...
    login: async (req,res) =>{
        try{
            ...
            if (!usuario) return res.status(500).render('erro', { mensagem: "Credenciais inválidas"})
            ...
            // Gera o token de acesso, conendo o perfil
            const token = jwt.sign(
                {id: usuario.id, perfil: usuario.perfil, nome: usuário.nome},
